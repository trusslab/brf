...
func (call *BpfCall) getArgConstraints(s *BpfProg) []string {
...
func NewBpfProg(pt *BpfProgTypeDef, r *randGen, opt BrfGenProgOpt) *BpfProg {
	p := &BpfProg{
		pt: pt,
	...
	p.AttachOpt.IntOpts = make([]int64, 8)
	return p
}

func (s *BpfProg) NewMap(newMapType BpfMapType, hint *BpfCallGenHint, minValSize int, r *randGen) *BpfMap {
...
func (s *BpfProg) AddMap(typ string, flags []string, name string, key *StructDef, val *StructDef, size int64) *BpfMap {
	newMap := &BpfMap{
		MapType: typ,
		MapFlags: flags,
		MapName: name,
...
//func (s *BpfProg) ProgType() int {
//	return s.pt.Num
//}
//
//func (s *BpfProg) ProgTypeEnum() string {
//	return s.pt.Enum
//}
...
type RegType interface {
	String() string
	Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg
	CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool
}
...
func (t ScalarValRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
...
func (t ScalarValRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
	return true
}
...
func (t PtrToCtxRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
	a := NewBpfArg(call.Helper, arg)
...
func (t PtrToCtxRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
	return true
}
...
func generateStruct(s *BpfProg, r *randGen, sizeConstraints []int, hints map[ArgHint]bool, useHint bool, minSizeHint int) (*StructDef, bool) {
...
func getHelperCompatMaps(s *BpfProg, call *BpfCall) []*BpfMap {
...
func getHelperCompatMapTypes(s *BpfProg, call *BpfCall) []BpfMapType {
...
func getCompatKeyStructDefs(s *BpfProg, mapType BpfMapType) []*StructDef {
...
func getCompatValStructDefs(s *BpfProg, hint *BpfCallGenHint, minValSize int, mapType BpfMapType) []*StructDef {
	var compatStructs []*StructDef
	for _, structDef := range s.Structs {
...
func (t ConstPtrToMapRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
	a := NewBpfArg(call.Helper, arg)
	a.IsNotNull = true
...
func (t ConstPtrToMapRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
	return true
}
...
func (t PtrToMapValueRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
	//XXX Consider record loaded map values and reuse them
	return nil
}

func (t PtrToMapValueRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
	return true
}
...
func (t PtrToStackRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
	a := NewBpfArg(call.Helper, arg)
...
func (t PtrToStackRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
	return true
}
...
func checkPktAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
	canWrite := true
...
func (t PtrToPacketMetaRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
	return nil
}

func (t PtrToPacketMetaRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
...
func (t PtrToPacketRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
	return nil
}

func (t PtrToPacketRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
	return checkPktAccess(s, h, isWrite)
}
...
func (t PtrToPacketEndRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
	return nil
}

func (t PtrToPacketEndRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
...
func (t PtrToFlowKeysRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
	return nil
}

func (t PtrToFlowKeysRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
	return true
}
...
func (t PtrToSocketRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
	return nil
}

func (t PtrToSocketRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
	return !isWrite
}
...
func (t PtrToSockCommonRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
	return nil
}

func (t PtrToSockCommonRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
	return !isWrite
}
...
func (t PtrToTcpSockRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
	return nil
}

func (t PtrToTcpSockRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
	return !isWrite
}
...
func (t PtrToTpBufferRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
	return nil
}

func (t PtrToTpBufferRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
	return true
}
...
func (t PtrToXdpSockRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
	return nil
}

func (t PtrToXdpSockRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
	return !isWrite
}
...
func (t PtrToBtfIdRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
	return nil
}

func (t PtrToBtfIdRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
	return true
}
...
func (t PtrToMemRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
	return nil
}

func (t PtrToMemRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
	return true
}
...
func (t PtrToRdOnlyBufRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
	return nil
}

func (t PtrToRdOnlyBufRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
	return !isWrite
}
...
func (t PtrToRdWrBufRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
	return nil
}

func (t PtrToRdWrBufRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
	return true
}
...
func (t PtrToPercpuBtfIdRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
	a := NewBpfArg(call.Helper, arg)
...
func (t PtrToPercpuBtfIdRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
	//XXX not found in check_mem_access
	return false
}
...
func (t PtrToFuncRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
	return nil
}

func (t PtrToFuncRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
	//XXX not found in check_mem_access
	return false
}
...
func (t PtrToMapKeyRegType) Generate(s *BpfProg, r *randGen, call *BpfCall, arg int) *BpfArg {
	return nil
}

func (t PtrToMapKeyRegType) CheckAccess(s *BpfProg, h *BpfHelperFunc, isWrite bool) bool {
	return !isWrite
}
...
func (brf *BpfRuntimeFuzzer) InitFromSrc(hMap map[string]*BpfHelperFunc, ptMap map[BpfProgTypeEnum]*BpfProgTypeDef, caMap map[BpfProgTypeEnum]*BpfCtxAccess) {
...
func findMember(s *BpfProg, structType string, memberType string) int {
...
func (s *BpfProg) genBpfHelperCallArg(r *randGen, call *BpfCall, arg int) bool {
...
func (s *BpfProg) genCompatibleRegTypes(call *BpfCall, arg int) ([]RegType, string) {
	argType := call.Helper.Args[arg]
...
func (s *BpfProg) genRandDirectAccess(r *randGen, call *BpfCall, arg int) (*BpfArg, bool) {
...
func (s *BpfProg) genRandBpfCtxAccess(r *randGen, call *BpfCall, arg int) (*BpfArg, bool) {
	compatRegTypes, _ := s.genCompatibleRegTypes(call, arg)
	for i := 0; i < 5; i++ {
		a := NewBpfArg(call.Helper, arg)
...
func (s *BpfProg) getBpfHelpers(enums []string) ([]*BpfHelperFunc) {
	var helpers []*BpfHelperFunc
...
func (s *BpfProg) genBpfHelperCall(r *randGen, helper *BpfHelperFunc, hint *BpfCallGenHint, prepend bool) (*BpfCall, bool) {
	rd += 1
	if rd > 100 {
...
func (s *BpfProg) genRandBpfHelperCall(r *randGen, call *BpfCall, arg int) (*BpfArg, bool) {
	a := NewBpfArg(call.Helper, arg)
...
func (brf *BpfRuntimeFuzzer) MutBpfProg(r *randGen, s *BpfProg, opt BrfGenProgOpt) bool {
	var calls []*BpfCall
...
func (s *BpfProg) FixRef(r *randGen) {
...
func (s *BpfProg) FixSpinLock(r *randGen) {
	lockHeld := ""
	for i, call := range s.Calls {
...
#define DEFINE_BPF_MAP_IN_MAP(the_map, TypeOfMap, MapFlags, TypeOfKey, TypeOfValue, MaxEntries, innerMap) \
        struct {                                                        \
            __uint(type, TypeOfMap);                                    \
            __uint(map_flags, (MapFlags));                              \
            __uint(max_entries, (MaxEntries));                          \
            __type(key, TypeOfKey);                                     \
            __array(values, typeof(innerMap));                          \
        } the_map SEC(".maps") = { .values = {&innerMap}, };

#define DEFINE_BPF_MAP_NO_KEY(the_map, TypeOfMap, MapFlags, TypeOfValue, MaxEntries) \
        struct {                                                        \
            __uint(type, TypeOfMap);                                    \
            __uint(map_flags, (MapFlags));                              \
            __uint(max_entries, (MaxEntries));                          \
...
#define DEFINE_BPF_MAP_NO_VAL(the_map, TypeOfMap, MapFlags, TypeOfKey, MaxEntries) \
        struct {                                                        \
            __uint(type, TypeOfMap);                                    \
            __uint(map_flags, (MapFlags));                              \
            __uint(max_entries, (MaxEntries));                          \
...
#define DEFINE_BPF_MAP_NO_KEY_VAL(the_map, TypeOfMap, MapFlags, MaxEntries) \
        struct {                                                        \
            __uint(type, TypeOfMap);                                    \
            __uint(map_flags, (MapFlags));                              \
            __uint(max_entries, (MaxEntries));                          \
